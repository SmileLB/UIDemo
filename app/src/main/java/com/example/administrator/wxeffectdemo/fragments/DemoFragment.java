package com.example.administrator.wxeffectdemo.fragments;
...
import com.example.administrator.wxeffectdemo.adapter.DemoAdapter;
...
public class DemoFragment extends Fragment {
	...
	private void initDemoSettings(View view) {
		...
		final Activity5 Activity5 = (Activity5) getActivity();
		...
		switchColored.setChecked(Activity5.isBottomNavigationColored());
		switchFiveItems.setChecked(Activity5.getBottomNavigationNbItems() == 5);
