...
import com.example.administrator.wxeffectdemo.adapter.DemoViewPagerAdapter;
import com.example.administrator.wxeffectdemo.fragments.DemoFragment;
import com.example.mylibrary.ahBottomNavigation.AHBottomNavigation;
import com.example.mylibrary.ahBottomNavigation.AHBottomNavigationAdapter;
import com.example.mylibrary.ahBottomNavigation.AHBottomNavigationItem;
import com.example.mylibrary.ahBottomNavigation.AHBottomNavigationViewPager;
import com.example.mylibrary.ahBottomNavigation.notification.AHNotification;
    ...
    private void initUI() {
		...
		bottomNavigation.setOnNavigationPositionListener(new AHBottomNavigation.OnNavigationPositionListener() {
			@Override public void onPositionChange(int y) {
				Log.d("Activity5", "BottomNavigation Position: " + y);
			}
		});
		*/
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                AHNotification notification = new AHNotification.Builder()
                        .setText(":)")
                        .setBackgroundColor(ContextCompat.getColor(Activity5.this, R.color.color_notification_back))
                        .setTextColor(ContextCompat.getColor(Activity5.this, R.color.color_notification_text))
                        .build();
